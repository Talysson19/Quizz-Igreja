                    ...
                    <div className="lg:col-span-1 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm h-fit">
                        ...
                        <form onSubmit={handleRegisterChurch} className="space-y-4">
                            ...
                            <button 
                                type="submit" 
                                disabled={submitting}
                                className={`w-full text-white font-bold py-3 rounded-xl transition-all shadow-md active:scale-95 mt-2 text-sm flex items-center justify-center gap-2 ${
                                    submitting ? 'bg-slate-500 cursor-not-allowed opacity-80' : 'bg-slate-700 hover:bg-slate-800'
                                }`}
                            >
                                {submitting ? (
                                    <>
